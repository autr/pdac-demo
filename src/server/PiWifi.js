...
var tools = require('wireless-tools-alt');
 ...
 */
function setNetworkParameter(interface_, networkId, name, value, callback) {
  tools.wpa.set_network(interface_, networkId, name, value, callback);
}
