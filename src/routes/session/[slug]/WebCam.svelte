...
<div class="webcam b2-solid" on:click style="width: 360px; height:360px; ratio: 1; {style}; overflow: hidden; flex-direction: row; align-items:center;justify-items: center;" >
  <video 
    bind:this={ref} 
    style="height: 100%; ratio: 1; position: absolute;left:50%;top:50%;transform:translate(-50%,-50%)">
